...
public class LazyLoadBehaviour : MonoBehaviour
{
    ...
    {
        get{return rectTransformComponent ? rectTransformComponent : (rectTransformComponent = GetComponent<RectTransform>());}
    }
    ...
    {
        get { return rigidbody2DComponent ? rigidbody2DComponent : (rigidbody2DComponent = GetComponent<Rigidbody2D>()); }
    }
    ...
    {
        get { return collider2DComponent ? collider2DComponent : (collider2DComponent = GetComponent<Collider2D>()); }
    }
    
    private BoxCollider2D boxCollider2DComponent;
    public BoxCollider2D BoxCollider2D
    {
        get { return boxCollider2DComponent ? boxCollider2DComponent : (boxCollider2DComponent = GetComponent<BoxCollider2D>()); }
    }
    
    private CapsuleCollider2D capsuleCollider2DComponent;
    public CapsuleCollider2D CapsuleCollider2D
    {
        get { return capsuleCollider2DComponent ? capsuleCollider2DComponent : (capsuleCollider2DComponent = GetComponent<CapsuleCollider2D>()); }
    }
    
    private CircleCollider2D circleCollider2DComponent;
    public CircleCollider2D CircleCollider2D
    {
        get { return circleCollider2DComponent ? circleCollider2DComponent : (circleCollider2DComponent = GetComponent<CircleCollider2D>()); }
    }
    
    private EdgeCollider2D edgeCollider2DComponent;
    public EdgeCollider2D EdgeCollider2D
    {
        get { return edgeCollider2DComponent ? edgeCollider2DComponent : (edgeCollider2DComponent = GetComponent<EdgeCollider2D>()); }
    }
    ...
    {
        get { return particleSystemComponent ? particleSystemComponent : (particleSystemComponent = GetComponent<ParticleSystem>());}
    }
